...
import  {handleCheckboxTask, DeletetodoTask, AddNewTask} from './actions/actions';
...
todos &&  (todos.map(todo=>{
        <li key={todo.id}>
        <span style={{textDecoration: todo.completed?"line-through": "none"}} onClick={handleCheckbox(todo.id)}>
        {todo.title}
        <span>
